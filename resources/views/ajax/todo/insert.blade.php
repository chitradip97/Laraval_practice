            ...
            $.ajax({
                ...
                'success':function(data,status){
                    if(status=="success")
                    {
                       ...
                       if(data.active=1)
                       {
                        $('#info').html('<h4 style="color:green; font-weight: bold">Your data is successfully inserted.</h4>');
                       }
                       else
                       {
        ...
        {{-- <form action="{{url('/insert_backend')}}" method="POST"> --}}
           ...
           <tr>
            ...
            <tr>
               ...
               <td><button onclick="insert_todo()">Submit</button></td> 
            </tr>
